...
var app = (function () {
    ...
    // (194:0) {#if screen == "home"}
    function create_if_block_3$2(ctx) {
    	let current;

    	const home = new Home({
    			props: {
    				newGamePage: /*newGamePage*/ ctx[12],
    				continueGamePage: /*continueGamePage*/ ctx[13]
    			},
    			$$inline: true
    		});
    ...
    function create_if_block_2$2(ctx) {
    	...
    	function newgame_screen_binding(value) {
    		/*newgame_screen_binding*/ ctx[23].call(null, value);
    	}
    	...
    	let newgame_props = {
    		...
    		loading: /*loading*/ ctx[2],
    		numNewGameUsers: /*numNewGameUsers*/ ctx[10],
    		newGameUsers: /*newGameUsers*/ ctx[11]
    	};
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$9, 202, 1, 4964);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    			mount_component(loader, main, null);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, currentUsername, gameName*/ 268435474) {
    				form_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(202:0) {#if screen == \\\"continue game\\\"}",
    		ctx
    	});
    ...
    function create_default_slot_7$1(ctx) {
    	...
    	function input_value_binding(value) {
    		/*input_value_binding*/ ctx[24].call(null, value);
    	}

    	let input_props = {};

    	if (/*gameName*/ ctx[1] !== void 0) {
    		input_props.value = /*gameName*/ ctx[1];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*gameName*/ 2) {
    				updating_value = true;
    				input_changes.value = /*gameName*/ ctx[1];
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    function create_default_slot_5$1(ctx) {
    	...
    	function input_value_binding_1(value) {
    		/*input_value_binding_1*/ ctx[25].call(null, value);
    	}

    	let input_props = {};

    	if (/*currentUsername*/ ctx[4] !== void 0) {
    		input_props.value = /*currentUsername*/ ctx[4];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*currentUsername*/ 16) {
    				updating_value = true;
    				input_changes.value = /*currentUsername*/ ctx[4];
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    // (216:4) <Button color="success" type="button" on:click={pullGame}>
    function create_default_slot_4$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(216:4) <Button color=\\\"success\\\" type=\\\"button\\\" on:click={pullGame}>",
    		ctx
    	});
    ...
    function create_default_slot_3$1(ctx) {
    	...
    	button.$on("click", /*pullGame*/ ctx[14]);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "button-group-horizontal-center svelte-1b1evmh");
    			add_location(div, file$9, 214, 3, 5288);
    		},
    		m: function mount(target, anchor) {
    			mount_component(formgroup0, target, anchor);
    			insert_dev(target, t0, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, gameName*/ 268435458) {
    				formgroup0_changes.$$scope = { dirty, ctx };
    			}
    			...
    			if (dirty & /*$$scope, currentUsername*/ 268435472) {
    				formgroup1_changes.$$scope = { dirty, ctx };
    			}
    ...
    function create_if_block$4(ctx) {
    	...
    	if (/*warpLength*/ ctx[9] !== void 0) {
    		input0_props.value = /*warpLength*/ ctx[9];
    	}
    	...
    	if (/*warpType*/ ctx[8] !== void 0) {
    		input1_props.value = /*warpType*/ ctx[8];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*loading*/ 4) loader_changes.loading = /*loading*/ ctx[2];
    			loader.$set(loader_changes);
    			if (!current || dirty & /*gameName*/ 2) set_data_dev(t8, /*gameName*/ ctx[1]);
    			...
    			if (!updating_value && dirty & /*warpLength*/ 512) {
    				updating_value = true;
    				input0_changes.value = /*warpLength*/ ctx[9];
    				add_flush_callback(() => updating_value = false);
    			}
    			...
    			if (!updating_value_1 && dirty & /*warpType*/ 256) {
    				updating_value_1 = true;
    				input1_changes.value = /*warpType*/ ctx[8];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(222:0) {#if screen == \\\"play turn\\\"}",
    		ctx
    	});
    ...
    // (238:2) <Label style="margin-bottom:2px;margin-top:20px;">
    function create_default_slot_2$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(238:2) <Label style=\\\"margin-bottom:2px;margin-top:20px;\\\">",
    		ctx
    	});
    ...
    // (241:3) <Input type="select" bind:value={warpType}>
    function create_default_slot_1$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$9, 241, 4, 6309);
    			option1.__value = "seconds";
    			option1.value = option1.__value;
    			add_location(option1, file$9, 242, 4, 6344);
    			option2.__value = "minutes";
    			option2.value = option2.__value;
    			add_location(option2, file$9, 243, 4, 6390);
    			option3.__value = "hours";
    			option3.value = option3.__value;
    			add_location(option3, file$9, 244, 4, 6436);
    			option4.__value = "days";
    			option4.value = option4.__value;
    			add_location(option4, file$9, 245, 4, 6478);
    			option5.__value = "weeks";
    			option5.value = option5.__value;
    			add_location(option5, file$9, 246, 4, 6518);
    			option6.__value = "months";
    			option6.value = option6.__value;
    			add_location(option6, file$9, 247, 4, 6560);
    			option7.__value = "years";
    			option7.value = option7.__value;
    			add_location(option7, file$9, 248, 4, 6604);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(241:3) <Input type=\\\"select\\\" bind:value={warpType}>",
    		ctx
    	});
    ...
    // (253:3) <Button type="button" color="success" disabled={!isUsersTurn} on:click={submitTurn}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(253:3) <Button type=\\\"button\\\" color=\\\"success\\\" disabled={!isUsersTurn} on:click={submitTurn}>",
    		ctx
    	});
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	async function pullGame() {
    		let inGame = true;
    		$$invalidate(7, isUsersTurn = true);
    		$$invalidate(2, loading = true);
    		$$invalidate(3, spinnerText = "Downloading db...");
    		...
    		await multiplayer.pullGame(gameName, currentUsername).catch(err => {
    			...
    			if (err != "Not your turn") {
    				...
    				$$invalidate(7, isUsersTurn = false);
    			}
    		});
    		...
    		if (gameData && inGame) {
    			...
    			$$invalidate(1, gameName = gameData.gameName);
    			$$invalidate(5, currentTurn = gameData.currentTurn);
    			let shortestType = 10;
    			...
    			$$invalidate(6, shortestWarp = length + " " + warpType);
    	...
    	function input_value_binding_1(value) {
    		...
    		$$invalidate(4, currentUsername);
    	}

    	function input0_value_binding(value) {
    		warpLength = value;
    		$$invalidate(9, warpLength);
    	}

    	function input1_value_binding(value) {
    		warpType = value;
    		$$invalidate(8, warpType);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("numNewGameUsers" in $$props) $$invalidate(10, numNewGameUsers = $$props.numNewGameUsers);
    		if ("newGameUsers" in $$props) $$invalidate(11, newGameUsers = $$props.newGameUsers);
    		...
    		if ("currentUsername" in $$props) $$invalidate(4, currentUsername = $$props.currentUsername);
    		...
    		if ("warpType" in $$props) $$invalidate(8, warpType = $$props.warpType);
    		if ("warpTypeNum" in $$props) warpTypeNum = $$props.warpTypeNum;
    		if ("warpLength" in $$props) $$invalidate(9, warpLength = $$props.warpLength);
    	};
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$a, safe_not_equal, { name: 16 });
