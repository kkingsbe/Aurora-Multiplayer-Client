...
var app = (function () {
    ...
    function create_default_slot_1$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			option0.textContent = "Seconds";
    			t1 = space();
    			option1 = element("option");
    			option1.textContent = "Minutes";
    			t3 = space();
    			option2 = element("option");
    			option2.textContent = "Hours";
    			t5 = space();
    			option3 = element("option");
    			option3.textContent = "Days";
    			t7 = space();
    			option4 = element("option");
    			option4.textContent = "Weeks";
    			t9 = space();
    			option5 = element("option");
    			option5.textContent = "Months";
    			t11 = space();
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div7 = element("div");
    			div4 = element("div");
    			t8 = text(/*gameName*/ ctx[0]);
    			t9 = space();
    			div5 = element("div");
    			t10 = text(/*currentTurn*/ ctx[1]);
    			t11 = space();
    			div6 = element("div");
    			t12 = text(/*shortestWarp*/ ctx[2]);
    			t13 = space();
    			create_component(label.$$.fragment);
    			t14 = space();
    			div9 = element("div");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			loader.$set(loader_changes);
    			if (!current || dirty & /*gameName*/ 1) set_data_dev(t8, /*gameName*/ ctx[0]);
    			if (!current || dirty & /*currentTurn*/ 2) set_data_dev(t10, /*currentTurn*/ ctx[1]);
    			if (!current || dirty & /*shortestWarp*/ 4) set_data_dev(t12, /*shortestWarp*/ ctx[2]);
    			const label_changes = {};
    			...
    			if (dirty & /*isUsersTurn*/ 8) button_changes.disabled = !/*isUsersTurn*/ ctx[3];
    ...
    class PlayTurn extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*currentTurn*/ ctx[1] === undefined && !("currentTurn" in props)) {
    		...
    		if (/*isUsersTurn*/ ctx[3] === undefined && !("isUsersTurn" in props)) {
    ...
    function create_if_block_3$2(ctx) {
    	...
    	function home_screen_binding(value) {
    		/*home_screen_binding*/ ctx[9].call(null, value);
    	}
    ...
    function create_if_block_2$2(ctx) {
    	...
    	function newgame_screen_binding(value) {
    		/*newgame_screen_binding*/ ctx[10].call(null, value);
    	}

    	let newgame_props = {
    		gameName: /*gameName*/ ctx[1],
    		numNewGameUsers: /*numNewGameUsers*/ ctx[7],
    		newGameUsers: /*newGameUsers*/ ctx[8]
    	};
    ...
    function create_if_block_1$2(ctx) {
    	...
    	function continuegame_gameData_binding(value) {
    		/*continuegame_gameData_binding*/ ctx[11].call(null, value);
    	}

    	function continuegame_gameName_binding(value) {
    		/*continuegame_gameName_binding*/ ctx[12].call(null, value);
    	}

    	function continuegame_currentUsername_binding(value) {
    		/*continuegame_currentUsername_binding*/ ctx[13].call(null, value);
    	}

    	function continuegame_screen_binding(value) {
    		/*continuegame_screen_binding*/ ctx[14].call(null, value);
    	}

    	function continuegame_currentTurn_binding(value) {
    		/*continuegame_currentTurn_binding*/ ctx[15].call(null, value);
    	}

    	function continuegame_shortestWarp_binding(value) {
    		/*continuegame_shortestWarp_binding*/ ctx[16].call(null, value);
    	}

    	function continuegame_isUsersTurn_binding(value) {
    		/*continuegame_isUsersTurn_binding*/ ctx[17].call(null, value);
    	}
    ...
    function create_if_block$4(ctx) {
    	...
    	function playturn_screen_binding(value) {
    		/*playturn_screen_binding*/ ctx[18].call(null, value);
    	}

    	function playturn_currentTurn_binding(value) {
    		/*playturn_currentTurn_binding*/ ctx[19].call(null, value);
    	}

    	function playturn_currentUsername_binding(value) {
    		/*playturn_currentUsername_binding*/ ctx[20].call(null, value);
    	}

    	function playturn_shortestWarp_binding(value) {
    		/*playturn_shortestWarp_binding*/ ctx[21].call(null, value);
    	}

    	function playturn_isUsersTurn_binding(value) {
    		/*playturn_isUsersTurn_binding*/ ctx[22].call(null, value);
    	}
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("numNewGameUsers" in $$props) $$invalidate(7, numNewGameUsers = $$props.numNewGameUsers);
    		if ("newGameUsers" in $$props) $$invalidate(8, newGameUsers = $$props.newGameUsers);
