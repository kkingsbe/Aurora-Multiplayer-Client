...
var app = (function () {
    ...
    function create_if_block_2$2(ctx) {
    	...
    	button0.$on("click", /*newGamePage*/ ctx[2]);
    	...
    	button1.$on("click", /*continueGamePage*/ ctx[3]);
    ...
    function create_if_block_1$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, numNewGameUsers*/ 1026) {
    ...
    function create_default_slot_5(ctx) {
    	...
    	button0.$on("click", /*incrementUsers*/ ctx[4]);
    	...
    	button1.$on("click", /*decrementUsers*/ ctx[5]);
    ...
    function create_fragment$6(ctx) {
    	...
    	let current;
    	let if_block0 = /*screen*/ ctx[0] == "home" && create_if_block_2$2(ctx);
    	let if_block1 = /*screen*/ ctx[0] == "new game" && create_if_block_1$2(ctx);
    	let if_block2 = /*screen*/ ctx[0] == "continue game" && create_if_block$3(ctx);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { name: 6 });
