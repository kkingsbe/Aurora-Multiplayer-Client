...
var app = (function () {
    ...
    // (20:4) <Button type="button" color="primary" on:click={newGamePage}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(20:4) <Button type=\\\"button\\\" color=\\\"primary\\\" on:click={newGamePage}>",
    		ctx
    	});
    ...
    // (21:4) <Button type="button" color="secondary" on:click={continueGamePage}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(21:4) <Button type=\\\"button\\\" color=\\\"secondary\\\" on:click={continueGamePage}>",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "button-group svelte-1u5vfjo");
    			add_location(div, file$6, 18, 2, 387);
    			attr_dev(main, "class", "svelte-1u5vfjo");
    ...
    // (58:6) {#each Array(numNewGameUsers) as _, i}
    function create_each_block(ctx) {
    	...
    	if (/*newGameUsers*/ ctx[4][/*i*/ ctx[16]] !== void 0) {
    		input_props.value = /*newGameUsers*/ ctx[4][/*i*/ ctx[16]];
    	}
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*newGameUsers*/ 16) {
    				updating_value = true;
    				input_changes.value = /*newGameUsers*/ ctx[4][/*i*/ ctx[16]];
    				add_flush_callback(() => updating_value = false);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(58:6) {#each Array(numNewGameUsers) as _, i}",
    		ctx
    	});
    ...
    function create_default_slot_4(ctx) {
    	...
    	let each_value = Array(/*numNewGameUsers*/ ctx[3]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*newGameUsers, numNewGameUsers*/ 24) {
    				each_value = Array(/*numNewGameUsers*/ ctx[3]);
    				validate_each_argument(each_value);
    				let i;
    ...
    // (63:6) <Button color="primary" type="button" id="addUserBtn" on:click={incrementUsers}>
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(63:6) <Button color=\\\"primary\\\" type=\\\"button\\\" id=\\\"addUserBtn\\\" on:click={incrementUsers}>",
    		ctx
    	});
    ...
    // (64:6) <Button color="danger" type="button" id="addUserBtn" on:click={decrementUsers}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(64:6) <Button color=\\\"danger\\\" type=\\\"button\\\" id=\\\"addUserBtn\\\" on:click={decrementUsers}>",
    		ctx
    	});
    ...
    // (67:6) <Button color="success" type="button" on:click={uploadGame}>
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(67:6) <Button color=\\\"success\\\" type=\\\"button\\\" on:click={uploadGame}>",
    		ctx
    	});
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 61, 4, 1688);
    			attr_dev(div1, "class", "button-group-horizontal-center svelte-qjuoc6");
    			add_location(div1, file$8, 65, 4, 1944);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, numNewGameUsers, newGameUsers*/ 131096) {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$8, 46, 0, 1226);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*spinnerText*/ 2) loader_changes.spinnerText = /*spinnerText*/ ctx[1];
    			if (dirty & /*loading*/ 4) loader_changes.loading = /*loading*/ ctx[2];
    			loader.$set(loader_changes);
    			const form_changes = {};

    			if (dirty & /*$$scope, numNewGameUsers, newGameUsers, gameName*/ 131097) {
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	function incrementUsers() {
    		$$invalidate(3, numNewGameUsers++, numNewGameUsers);
    	}
    	...
    	async function uploadGame() {
    		...
    		$$invalidate(1, spinnerText = "Creating Game...");
    	...
    	function input_value_binding_1(value, i) {
    		...
    		$$invalidate(4, newGameUsers);
    	}

    	$$self.$set = $$props => {
    		if ("gameName" in $$props) $$invalidate(0, gameName = $$props.gameName);
    		if ("spinnerText" in $$props) $$invalidate(1, spinnerText = $$props.spinnerText);
    		if ("loading" in $$props) $$invalidate(2, loading = $$props.loading);
    		if ("numNewGameUsers" in $$props) $$invalidate(3, numNewGameUsers = $$props.numNewGameUsers);
    		if ("newGameUsers" in $$props) $$invalidate(4, newGameUsers = $$props.newGameUsers);
    ...
    class NewGame extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*spinnerText*/ ctx[1] === undefined && !("spinnerText" in props)) {
    			console_1$1.warn("<NewGame> was created without expected prop 'spinnerText'");
    		}

    		if (/*loading*/ ctx[2] === undefined && !("loading" in props)) {
    			console_1$1.warn("<NewGame> was created without expected prop 'loading'");
    		}

    		if (/*numNewGameUsers*/ ctx[3] === undefined && !("numNewGameUsers" in props)) {
    			console_1$1.warn("<NewGame> was created without expected prop 'numNewGameUsers'");
    		}

    		if (/*newGameUsers*/ ctx[4] === undefined && !("newGameUsers" in props)) {
    ...
    function create_default_slot_4$1(ctx) {
    	...
    	if (/*gameName*/ ctx[2] !== void 0) {
    		input_props.value = /*gameName*/ ctx[2];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*gameName*/ 4) {
    				updating_value = true;
    				input_changes.value = /*gameName*/ ctx[2];
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    function create_default_slot_2$1(ctx) {
    	...
    	if (/*currentUsername*/ ctx[3] !== void 0) {
    		input_props.value = /*currentUsername*/ ctx[3];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*currentUsername*/ 8) {
    				updating_value = true;
    				input_changes.value = /*currentUsername*/ ctx[3];
    				add_flush_callback(() => updating_value = false);
    			}
    ...
    // (153:6) <Button color="success" type="button" on:click={pullGame}>
    function create_default_slot_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(153:6) <Button color=\\\"success\\\" type=\\\"button\\\" on:click={pullGame}>",
    		ctx
    	});
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 151, 4, 3719);
    		},
    		m: function mount(target, anchor) {
    			mount_component(formgroup0, target, anchor);
    			insert_dev(target, t0, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, gameName*/ 262148) {
    				formgroup0_changes.$$scope = { dirty, ctx };
    			}
    			...
    			if (dirty & /*$$scope, currentUsername*/ 262152) {
    				formgroup1_changes.$$scope = { dirty, ctx };
    			}
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$9, 139, 0, 3382);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, currentUsername, gameName*/ 262156) {
    				form_changes.$$scope = { dirty, ctx };
    			}
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	async function pullGame() {
    		...
    		$$invalidate(1, spinnerText = "Downloading db...");
    		...
    		if (gameData && inGame) {
    			...
    			console.log(screen);
    			$$invalidate(2, gameName = gameData.gameName);
    	...
    	$$self.$set = $$props => {
    		...
    		if ("spinnerText" in $$props) $$invalidate(1, spinnerText = $$props.spinnerText);
    		if ("gameName" in $$props) $$invalidate(2, gameName = $$props.gameName);
    ...
    class ContinueGame extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*loading*/ ctx[0] === undefined && !("loading" in props)) {
    			console_1$2.warn("<ContinueGame> was created without expected prop 'loading'");
    		}

    		if (/*spinnerText*/ ctx[1] === undefined && !("spinnerText" in props)) {
    			console_1$2.warn("<ContinueGame> was created without expected prop 'spinnerText'");
    		}

    		if (/*gameName*/ ctx[2] === undefined && !("gameName" in props)) {
    			console_1$2.warn("<ContinueGame> was created without expected prop 'gameName'");
    		}

    		if (/*currentUsername*/ ctx[3] === undefined && !("currentUsername" in props)) {
    ...
    // (78:2) <Label style="margin-bottom:2px;margin-top:20px;">
    function create_default_slot_2$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(78:2) <Label style=\\\"margin-bottom:2px;margin-top:20px;\\\">",
    		ctx
    	});
    ...
    // (81:4) <Input type="select" bind:value={warpType}>
    function create_default_slot_1$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$a, 81, 6, 2363);
    			option1.__value = "seconds";
    			option1.value = option1.__value;
    			add_location(option1, file$a, 82, 6, 2400);
    			option2.__value = "minutes";
    			option2.value = option2.__value;
    			add_location(option2, file$a, 83, 6, 2448);
    			option3.__value = "hours";
    			option3.value = option3.__value;
    			add_location(option3, file$a, 84, 6, 2496);
    			option4.__value = "days";
    			option4.value = option4.__value;
    			add_location(option4, file$a, 85, 6, 2540);
    			option5.__value = "weeks";
    			option5.value = option5.__value;
    			add_location(option5, file$a, 86, 6, 2582);
    			option6.__value = "months";
    			option6.value = option6.__value;
    			add_location(option6, file$a, 87, 6, 2626);
    			option7.__value = "years";
    			option7.value = option7.__value;
    			add_location(option7, file$a, 88, 6, 2672);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(81:4) <Input type=\\\"select\\\" bind:value={warpType}>",
    		ctx
    	});
    ...
    // (93:4) <Button type="button" color="success" disabled={!isUsersTurn} on:click={submitTurn}>
    function create_default_slot$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(93:4) <Button type=\\\"button\\\" color=\\\"success\\\" disabled={!isUsersTurn} on:click={submitTurn}>",
    		ctx
    	});
    ...
    function create_fragment$b(ctx) {
    	...
    	if (/*warpLength*/ ctx[2] !== void 0) {
    		input0_props.value = /*warpLength*/ ctx[2];
    	}
    	...
    	if (/*warpType*/ ctx[3] !== void 0) {
    		input1_props.value = /*warpType*/ ctx[3];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			div7 = element("div");
    			div4 = element("div");
    			t8 = text(/*gameName*/ ctx[4]);
    			t9 = space();
    			div5 = element("div");
    			t10 = text(/*currentTurn*/ ctx[5]);
    			t11 = space();
    			div6 = element("div");
    			t12 = text(/*shortestWarp*/ ctx[6]);
    			t13 = space();
    			create_component(label.$$.fragment);
    			t14 = space();
    			div9 = element("div");
    		...
    		p: function update(ctx, [dirty]) {
    			const loader_changes = {};
    			if (dirty & /*spinnerText*/ 1) loader_changes.spinnerText = /*spinnerText*/ ctx[0];
    			if (dirty & /*loading*/ 2) loader_changes.loading = /*loading*/ ctx[1];
    			loader.$set(loader_changes);
    			if (!current || dirty & /*gameName*/ 16) set_data_dev(t8, /*gameName*/ ctx[4]);
    			if (!current || dirty & /*currentTurn*/ 32) set_data_dev(t10, /*currentTurn*/ ctx[5]);
    			if (!current || dirty & /*shortestWarp*/ 64) set_data_dev(t12, /*shortestWarp*/ ctx[6]);
    			const label_changes = {};
    			...
    			if (!updating_value && dirty & /*warpLength*/ 4) {
    				updating_value = true;
    				input0_changes.value = /*warpLength*/ ctx[2];
    				add_flush_callback(() => updating_value = false);
    			}
    			...
    			if (!updating_value_1 && dirty & /*warpType*/ 8) {
    				updating_value_1 = true;
    				input1_changes.value = /*warpType*/ ctx[3];
    				add_flush_callback(() => updating_value_1 = false);
    			}

    			input1.$set(input1_changes);
    			const button_changes = {};
    			if (dirty & /*isUsersTurn*/ 128) button_changes.disabled = !/*isUsersTurn*/ ctx[7];
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	let { currentUsername } = $$props;
    	let { shortestWarp } = $$props;
    	let { warpLength } = $$props;
    	let { warpType } = $$props;
    	let { isUsersTurn } = $$props;
    	let { warpTypeNum } = $$props;

    	async function submitTurn() {
    		console.log(currentUsername);
    		$$invalidate(1, loading = true);
    		$$invalidate(0, spinnerText = "Uploading db...");
    		console.log(warpType);

    		switch (warpType) {
    			case "seconds":
    				$$invalidate(10, warpTypeNum = 1);
    				break;
    			case "minutes":
    				$$invalidate(10, warpTypeNum = 2);
    				break;
    			case "hours":
    				$$invalidate(10, warpTypeNum = 3);
    				break;
    			case "days":
    				$$invalidate(10, warpTypeNum = 4);
    				break;
    			case "weeks":
    				$$invalidate(10, warpTypeNum = 5);
    				break;
    			case "months":
    				$$invalidate(10, warpTypeNum = 6);
    				break;
    			case "years":
    				$$invalidate(10, warpTypeNum = 7);
    				break;
    		}

    		console.log(currentUsername);

    		let nextPlayer = await multiplayer.submitTurn(gameName, currentUsername, {
    			type: warpTypeNum,
    			length: warpLength,
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<PlayTurn> was created with unknown prop '${key}'`);
    	});
    	...
    	function input0_value_binding(value) {
    		warpLength = value;
    		$$invalidate(2, warpLength);
    	}

    	function input1_value_binding(value) {
    		warpType = value;
    		$$invalidate(3, warpType);
    	}
    	...
    	$$self.$set = $$props => {
    		...
    		if ("currentTurn" in $$props) $$invalidate(5, currentTurn = $$props.currentTurn);
    		if ("currentUsername" in $$props) $$invalidate(11, currentUsername = $$props.currentUsername);
    		if ("shortestWarp" in $$props) $$invalidate(6, shortestWarp = $$props.shortestWarp);
    		if ("warpLength" in $$props) $$invalidate(2, warpLength = $$props.warpLength);
    		if ("warpType" in $$props) $$invalidate(3, warpType = $$props.warpType);
    		if ("isUsersTurn" in $$props) $$invalidate(7, isUsersTurn = $$props.isUsersTurn);
    		if ("warpTypeNum" in $$props) $$invalidate(10, warpTypeNum = $$props.warpTypeNum);
    	};
    ...
    class PlayTurn extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*screen*/ ctx[9] === undefined && !("screen" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'screen'");
    		}

    		if (/*spinnerText*/ ctx[0] === undefined && !("spinnerText" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'spinnerText'");
    		}

    		if (/*loading*/ ctx[1] === undefined && !("loading" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'loading'");
    		}

    		if (/*gameName*/ ctx[4] === undefined && !("gameName" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'gameName'");
    		}

    		if (/*currentTurn*/ ctx[5] === undefined && !("currentTurn" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'currentTurn'");
    		}

    		if (/*currentUsername*/ ctx[11] === undefined && !("currentUsername" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'currentUsername'");
    		}

    		if (/*shortestWarp*/ ctx[6] === undefined && !("shortestWarp" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'shortestWarp'");
    		}

    		if (/*warpLength*/ ctx[2] === undefined && !("warpLength" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'warpLength'");
    		}

    		if (/*warpType*/ ctx[3] === undefined && !("warpType" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'warpType'");
    		}

    		if (/*isUsersTurn*/ ctx[7] === undefined && !("isUsersTurn" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'isUsersTurn'");
    		}

    		if (/*warpTypeNum*/ ctx[10] === undefined && !("warpTypeNum" in props)) {
    			console_1$3.warn("<PlayTurn> was created without expected prop 'warpTypeNum'");
    		}
    	}
    ...
    function create_if_block_3$2(ctx) {
    	...
    	function home_screen_binding(value) {
    		/*home_screen_binding*/ ctx[15].call(null, value);
    	}
    ...
    // (33:0) {#if screen == "new game"}
    function create_if_block_2$2(ctx) {
    	let updating_screen;
    	let current;

    	function newgame_screen_binding(value) {
    		/*newgame_screen_binding*/ ctx[16].call(null, value);
    	}

    	let newgame_props = {
    		gameName: /*gameName*/ ctx[1],
    		spinnerText: /*spinnerText*/ ctx[12],
    		loading: /*loading*/ ctx[11],
    		numNewGameUsers: /*numNewGameUsers*/ ctx[9],
    		newGameUsers: /*newGameUsers*/ ctx[10]
    	};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(33:0) {#if screen == \\\"new game\\\"}",
    		ctx
    	});
    ...
    function create_if_block_1$2(ctx) {
    	...
    	let updating_isUsersTurn;
    	let current;

    	function continuegame_gameData_binding(value) {
    		/*continuegame_gameData_binding*/ ctx[17].call(null, value);
    	}

    	function continuegame_gameName_binding(value) {
    		/*continuegame_gameName_binding*/ ctx[18].call(null, value);
    	}

    	function continuegame_currentUsername_binding(value) {
    		/*continuegame_currentUsername_binding*/ ctx[19].call(null, value);
    	}

    	function continuegame_screen_binding(value) {
    		/*continuegame_screen_binding*/ ctx[20].call(null, value);
    	}

    	function continuegame_currentTurn_binding(value) {
    		/*continuegame_currentTurn_binding*/ ctx[21].call(null, value);
    	}

    	function continuegame_shortestWarp_binding(value) {
    		/*continuegame_shortestWarp_binding*/ ctx[22].call(null, value);
    	}

    	function continuegame_isUsersTurn_binding(value) {
    		/*continuegame_isUsersTurn_binding*/ ctx[23].call(null, value);
    	}
    	...
    	if (/*currentTurn*/ ctx[4] !== void 0) {
    		continuegame_props.currentTurn = /*currentTurn*/ ctx[4];
    	}

    	if (/*shortestWarp*/ ctx[5] !== void 0) {
    		continuegame_props.shortestWarp = /*shortestWarp*/ ctx[5];
    	}

    	if (/*isUsersTurn*/ ctx[6] !== void 0) {
    		continuegame_props.isUsersTurn = /*isUsersTurn*/ ctx[6];
    	}
    	...
    	binding_callbacks.push(() => bind(continuegame, "currentTurn", continuegame_currentTurn_binding));
    	binding_callbacks.push(() => bind(continuegame, "shortestWarp", continuegame_shortestWarp_binding));
    	binding_callbacks.push(() => bind(continuegame, "isUsersTurn", continuegame_isUsersTurn_binding));
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_currentTurn && dirty & /*currentTurn*/ 16) {
    				updating_currentTurn = true;
    				continuegame_changes.currentTurn = /*currentTurn*/ ctx[4];
    				add_flush_callback(() => updating_currentTurn = false);
    			}

    			if (!updating_shortestWarp && dirty & /*shortestWarp*/ 32) {
    				updating_shortestWarp = true;
    				continuegame_changes.shortestWarp = /*shortestWarp*/ ctx[5];
    				add_flush_callback(() => updating_shortestWarp = false);
    			}

    			if (!updating_isUsersTurn && dirty & /*isUsersTurn*/ 64) {
    				updating_isUsersTurn = true;
    				continuegame_changes.isUsersTurn = /*isUsersTurn*/ ctx[6];
    				add_flush_callback(() => updating_isUsersTurn = false);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(37:0) {#if screen == \\\"continue game\\\"}",
    		ctx
    	});
    ...
    // (41:0) {#if screen == "play turn"}
    function create_if_block$4(ctx) {
    	let updating_screen;
    	let updating_currentTurn;
    	let updating_currentUsername;
    	let updating_shortestWarp;
    	let updating_warpLength;
    	let updating_isUsersTurn;
    	let updating_warpTypeNum;
    	let current;

    	function playturn_screen_binding(value) {
    		/*playturn_screen_binding*/ ctx[24].call(null, value);
    	}

    	function playturn_currentTurn_binding(value) {
    		/*playturn_currentTurn_binding*/ ctx[25].call(null, value);
    	}

    	function playturn_currentUsername_binding(value) {
    		/*playturn_currentUsername_binding*/ ctx[26].call(null, value);
    	}

    	function playturn_shortestWarp_binding(value) {
    		/*playturn_shortestWarp_binding*/ ctx[27].call(null, value);
    	}

    	function playturn_warpLength_binding(value) {
    		/*playturn_warpLength_binding*/ ctx[28].call(null, value);
    	}

    	function playturn_isUsersTurn_binding(value) {
    		/*playturn_isUsersTurn_binding*/ ctx[29].call(null, value);
    	}

    	function playturn_warpTypeNum_binding(value) {
    		/*playturn_warpTypeNum_binding*/ ctx[30].call(null, value);
    	}
    	...
    	if (/*currentTurn*/ ctx[4] !== void 0) {
    		playturn_props.currentTurn = /*currentTurn*/ ctx[4];
    	}
    	...
    	if (/*shortestWarp*/ ctx[5] !== void 0) {
    		playturn_props.shortestWarp = /*shortestWarp*/ ctx[5];
    	}

    	if (/*warpLength*/ ctx[8] !== void 0) {
    		playturn_props.warpLength = /*warpLength*/ ctx[8];
    	}

    	if (/*isUsersTurn*/ ctx[6] !== void 0) {
    		playturn_props.isUsersTurn = /*isUsersTurn*/ ctx[6];
    	}

    	if (/*warpTypeNum*/ ctx[7] !== void 0) {
    		playturn_props.warpTypeNum = /*warpTypeNum*/ ctx[7];
    	}
    	...
    	binding_callbacks.push(() => bind(playturn, "currentTurn", playturn_currentTurn_binding));
    	...
    	binding_callbacks.push(() => bind(playturn, "warpLength", playturn_warpLength_binding));
    	binding_callbacks.push(() => bind(playturn, "isUsersTurn", playturn_isUsersTurn_binding));
    	binding_callbacks.push(() => bind(playturn, "warpTypeNum", playturn_warpTypeNum_binding));
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!updating_currentTurn && dirty & /*currentTurn*/ 16) {
    				updating_currentTurn = true;
    				playturn_changes.currentTurn = /*currentTurn*/ ctx[4];
    				add_flush_callback(() => updating_currentTurn = false);
    			}
    			...
    			if (!updating_shortestWarp && dirty & /*shortestWarp*/ 32) {
    				updating_shortestWarp = true;
    				playturn_changes.shortestWarp = /*shortestWarp*/ ctx[5];
    				add_flush_callback(() => updating_shortestWarp = false);
    			}

    			if (!updating_warpLength && dirty & /*warpLength*/ 256) {
    				updating_warpLength = true;
    				playturn_changes.warpLength = /*warpLength*/ ctx[8];
    				add_flush_callback(() => updating_warpLength = false);
    			}

    			if (!updating_isUsersTurn && dirty & /*isUsersTurn*/ 64) {
    				updating_isUsersTurn = true;
    				playturn_changes.isUsersTurn = /*isUsersTurn*/ ctx[6];
    				add_flush_callback(() => updating_isUsersTurn = false);
    			}

    			if (!updating_warpTypeNum && dirty & /*warpTypeNum*/ 128) {
    				updating_warpTypeNum = true;
    				playturn_changes.warpTypeNum = /*warpTypeNum*/ ctx[7];
    				add_flush_callback(() => updating_warpTypeNum = false);
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(41:0) {#if screen == \\\"play turn\\\"}",
    		ctx
    	});
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	function continuegame_currentTurn_binding(value) {
    		currentTurn = value;
    		$$invalidate(4, currentTurn);
    	}

    	function continuegame_shortestWarp_binding(value) {
    		shortestWarp = value;
    		$$invalidate(5, shortestWarp);
    	}

    	function continuegame_isUsersTurn_binding(value) {
    		isUsersTurn = value;
    		$$invalidate(6, isUsersTurn);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("numNewGameUsers" in $$props) $$invalidate(9, numNewGameUsers = $$props.numNewGameUsers);
    		if ("newGameUsers" in $$props) $$invalidate(10, newGameUsers = $$props.newGameUsers);
    		...
    		if ("spinnerText" in $$props) $$invalidate(12, spinnerText = $$props.spinnerText);
    		if ("currentUsername" in $$props) $$invalidate(3, currentUsername = $$props.currentUsername);
    		if ("currentTurn" in $$props) $$invalidate(4, currentTurn = $$props.currentTurn);
    		if ("shortestWarp" in $$props) $$invalidate(5, shortestWarp = $$props.shortestWarp);
    		if ("isUsersTurn" in $$props) $$invalidate(6, isUsersTurn = $$props.isUsersTurn);
    		if ("warpType" in $$props) warpType = $$props.warpType;
    		if ("warpTypeNum" in $$props) $$invalidate(7, warpTypeNum = $$props.warpTypeNum);
    		if ("warpLength" in $$props) $$invalidate(8, warpLength = $$props.warpLength);
    	};
    	...
    	return [
    		...
    		continuegame_currentTurn_binding,
    		continuegame_shortestWarp_binding,
    		continuegame_isUsersTurn_binding,
    		playturn_screen_binding,
    		playturn_currentTurn_binding,
    		playturn_currentUsername_binding,
    		playturn_shortestWarp_binding,
    		playturn_warpLength_binding,
    		playturn_isUsersTurn_binding,
    		playturn_warpTypeNum_binding
    	];
    }
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$c, create_fragment$c, safe_not_equal, { name: 13 });
