...
var app = (function () {
    ...
    // (12:4) <Button type="button" color="primary" on:click={newGamePage}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(12:4) <Button type=\\\"button\\\" color=\\\"primary\\\" on:click={newGamePage}>",
    		ctx
    	});
    ...
    // (13:4) <Button type="button" color="secondary" on:click={continueGamePage}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:4) <Button type=\\\"button\\\" color=\\\"secondary\\\" on:click={continueGamePage}>",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	button0.$on("click", function () {
    		if (is_function(/*newGamePage*/ ctx[0])) /*newGamePage*/ ctx[0].apply(this, arguments);
    	});
    	...
    	button1.$on("click", function () {
    		if (is_function(/*continueGamePage*/ ctx[1])) /*continueGamePage*/ ctx[1].apply(this, arguments);
    	});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 10, 2, 209);
    			attr_dev(main, "class", "svelte-1u5vfjo");
    			add_location(main, file$7, 8, 0, 160);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	let { newGamePage } = $$props;
    	let { continueGamePage } = $$props;
    	const writable_props = ["newGamePage", "continueGamePage"];
    	...
    	$$self.$set = $$props => {
    		if ("newGamePage" in $$props) $$invalidate(0, newGamePage = $$props.newGamePage);
    		if ("continueGamePage" in $$props) $$invalidate(1, continueGamePage = $$props.continueGamePage);
    	};
    	...
    	return [newGamePage, continueGamePage];
    }

    class Home extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { newGamePage: 0, continueGamePage: 1 });
    		...
    		if (/*newGamePage*/ ctx[0] === undefined && !("newGamePage" in props)) {
    			console.warn("<Home> was created without expected prop 'newGamePage'");
    		}

    		if (/*continueGamePage*/ ctx[1] === undefined && !("continueGamePage" in props)) {
    			console.warn("<Home> was created without expected prop 'continueGamePage'");
    		}
    	}
    	...
    	set newGamePage(value) {
    		throw new Error("<Home>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	get continueGamePage() {
    		throw new Error("<Home>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set continueGamePage(value) {
    		throw new Error("<Home>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    // (151:6) <Button color="success" type="button" on:click={pullGame}>
    function create_default_slot_1$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(151:6) <Button color=\\\"success\\\" type=\\\"button\\\" on:click={pullGame}>",
    		ctx
    	});
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 149, 4, 3663);
    		},
    		m: function mount(target, anchor) {
    			mount_component(formgroup0, target, anchor);
    			insert_dev(target, t0, anchor);
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$9, 137, 0, 3326);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("path" in $$props) path = $$props.path;
    		if ("multiplayer" in $$props) multiplayer = $$props.multiplayer;
    		if ("isUsersTurn" in $$props) isUsersTurn = $$props.isUsersTurn;
    ...
    function create_if_block_3$2(ctx) {
    	...
    	const home = new Home({
    			props: {
    				newGamePage: /*newGamePage*/ ctx[13],
    				continueGamePage: /*continueGamePage*/ ctx[14]
    			},
    			$$inline: true
    		});
    ...
    // (89:0) {#if screen == "new game"}
    function create_if_block_2$2(ctx) {
    	let updating_screen;
    	let current;

    	function newgame_screen_binding(value) {
    		/*newgame_screen_binding*/ ctx[22].call(null, value);
    	}

    	let newgame_props = {
    		gameName: /*gameName*/ ctx[10],
    		spinnerText: /*spinnerText*/ ctx[3],
    		loading: /*loading*/ ctx[2],
    		numNewGameUsers: /*numNewGameUsers*/ ctx[8],
    		newGameUsers: /*newGameUsers*/ ctx[9]
    	};
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*spinnerText*/ 8) newgame_changes.spinnerText = /*spinnerText*/ ctx[3];
    			if (dirty & /*loading*/ 4) newgame_changes.loading = /*loading*/ ctx[2];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(89:0) {#if screen == \\\"new game\\\"}",
    		ctx
    	});
    ...
    function create_if_block_1$2(ctx) {
    	...
    	function continuegame_gameData_binding(value) {
    		/*continuegame_gameData_binding*/ ctx[23].call(null, value);
    	}

    	function continuegame_screen_binding(value) {
    		/*continuegame_screen_binding*/ ctx[24].call(null, value);
    	}

    	function continuegame_currentTurn_binding(value) {
    		/*continuegame_currentTurn_binding*/ ctx[25].call(null, value);
    	}

    	function continuegame_shortestWarp_binding(value) {
    		/*continuegame_shortestWarp_binding*/ ctx[26].call(null, value);
    	}
    	...
    	let continuegame_props = {
    		...
    		spinnerText: /*spinnerText*/ ctx[3],
    		gameName: /*gameName*/ ctx[10],
    		currentUsername: /*currentUsername*/ ctx[11]
    	};

    	if (/*gameData*/ ctx[1] !== void 0) {
    		continuegame_props.gameData = /*gameData*/ ctx[1];
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*loading*/ 4) continuegame_changes.loading = /*loading*/ ctx[2];
    			if (dirty & /*spinnerText*/ 8) continuegame_changes.spinnerText = /*spinnerText*/ ctx[3];

    			if (!updating_gameData && dirty & /*gameData*/ 2) {
    				updating_gameData = true;
    				continuegame_changes.gameData = /*gameData*/ ctx[1];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(93:0) {#if screen == \\\"continue game\\\"}",
    		ctx
    	});
    ...
    function create_if_block$4(ctx) {
    	...
    	function input0_value_binding(value) {
    		/*input0_value_binding*/ ctx[27].call(null, value);
    	}
    	...
    	button.$on("click", /*submitTurn*/ ctx[15]);
    	...
    	const block = {
    		c: function create() {
    			...
    			div7 = element("div");
    			div4 = element("div");
    			div4.textContent = `${/*gameName*/ ctx[10]}`;
    			t9 = space();
    			div5 = element("div");
    			t10 = text(/*currentTurn*/ ctx[4]);
    			t11 = space();
    			div6 = element("div");
    			t12 = text(/*shortestWarp*/ ctx[5]);
    			t13 = space();
    			create_component(label.$$.fragment);
    			t14 = space();
    			div9 = element("div");
    			...
    			div10 = element("div");
    			create_component(button.$$.fragment);
    			attr_dev(div0, "class", "table-header-cell svelte-1b1evmh");
    			add_location(div0, file$a, 102, 4, 2816);
    			attr_dev(div1, "class", "table-header-cell svelte-1b1evmh");
    			add_location(div1, file$a, 103, 4, 2868);
    			attr_dev(div2, "class", "table-header-cell svelte-1b1evmh");
    			add_location(div2, file$a, 104, 4, 2923);
    			attr_dev(div3, "class", "horiz-table-header svelte-1b1evmh");
    			add_location(div3, file$a, 101, 3, 2778);
    			attr_dev(div4, "class", "table-cell svelte-1b1evmh");
    			add_location(div4, file$a, 107, 4, 3027);
    			attr_dev(div5, "class", "table-cell svelte-1b1evmh");
    			add_location(div5, file$a, 108, 4, 3073);
    			attr_dev(div6, "class", "table-cell svelte-1b1evmh");
    			add_location(div6, file$a, 109, 4, 3122);
    			attr_dev(div7, "class", "horiz-table-col svelte-1b1evmh");
    			add_location(div7, file$a, 106, 3, 2992);
    			attr_dev(div8, "class", "horiz-table svelte-1b1evmh");
    			add_location(div8, file$a, 100, 2, 2748);
    			attr_dev(div9, "class", "button-group-horizontal-center svelte-1b1evmh");
    			set_style(div9, "width", "300px");
    			set_style(div9, "margin-top", "0");
    			add_location(div9, file$a, 113, 2, 3285);
    			attr_dev(div10, "class", "button-group-horizontal-center svelte-1b1evmh");
    			add_location(div10, file$a, 126, 2, 3824);
    			attr_dev(main, "class", "svelte-1b1evmh");
    			add_location(main, file$a, 97, 1, 2643);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, main, anchor);
    			mount_component(loader, main, null);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*loading*/ 4) loader_changes.loading = /*loading*/ ctx[2];
    			loader.$set(loader_changes);
    			if (!current || dirty & /*currentTurn*/ 16) set_data_dev(t10, /*currentTurn*/ ctx[4]);
    			if (!current || dirty & /*shortestWarp*/ 32) set_data_dev(t12, /*shortestWarp*/ ctx[5]);
    			const label_changes = {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(97:0) {#if screen == \\\"play turn\\\"}",
    		ctx
    	});
    ...
    // (113:2) <Label style="margin-bottom:2px;margin-top:20px;">
    function create_default_slot_2$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(113:2) <Label style=\\\"margin-bottom:2px;margin-top:20px;\\\">",
    		ctx
    	});
    ...
    // (116:3) <Input type="select" bind:value={warpType}>
    function create_default_slot_1$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(option0, file$a, 116, 4, 3466);
    			option1.__value = "seconds";
    			option1.value = option1.__value;
    			add_location(option1, file$a, 117, 4, 3501);
    			option2.__value = "minutes";
    			option2.value = option2.__value;
    			add_location(option2, file$a, 118, 4, 3547);
    			option3.__value = "hours";
    			option3.value = option3.__value;
    			add_location(option3, file$a, 119, 4, 3593);
    			option4.__value = "days";
    			option4.value = option4.__value;
    			add_location(option4, file$a, 120, 4, 3635);
    			option5.__value = "weeks";
    			option5.value = option5.__value;
    			add_location(option5, file$a, 121, 4, 3675);
    			option6.__value = "months";
    			option6.value = option6.__value;
    			add_location(option6, file$a, 122, 4, 3717);
    			option7.__value = "years";
    			option7.value = option7.__value;
    			add_location(option7, file$a, 123, 4, 3761);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(116:3) <Input type=\\\"select\\\" bind:value={warpType}>",
    		ctx
    	});
    ...
    // (128:3) <Button type="button" color="success" disabled={!isUsersTurn} on:click={submitTurn}>
    function create_default_slot$3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(128:3) <Button type=\\\"button\\\" color=\\\"success\\\" disabled={!isUsersTurn} on:click={submitTurn}>",
    		ctx
    	});
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	async function submitTurn() {
    		$$invalidate(2, loading = true);
    		$$invalidate(3, spinnerText = "Uploading db...");
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("numNewGameUsers" in $$props) $$invalidate(8, numNewGameUsers = $$props.numNewGameUsers);
    		if ("newGameUsers" in $$props) $$invalidate(9, newGameUsers = $$props.newGameUsers);
    		if ("gameName" in $$props) $$invalidate(10, gameName = $$props.gameName);
    		...
    		if ("isUsersTurn" in $$props) $$invalidate(12, isUsersTurn = $$props.isUsersTurn);
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { name: 16 });
